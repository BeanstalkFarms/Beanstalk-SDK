...
export interface CurveMetaFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "add_existing_metapools",
    values: [PromiseOrValue<string>[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "base_pool_assets",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type PlainPoolDeployedEventFilter =
  TypedEventFilter<PlainPoolDeployedEvent>;
...
export type MetaPoolDeployedEventFilter =
  TypedEventFilter<MetaPoolDeployedEvent>;

export interface LiquidityGaugeDeployedEventObject {
  pool: string;
  gauge: string;
}
export type LiquidityGaugeDeployedEvent = TypedEvent<
  [string, string],
  LiquidityGaugeDeployedEventObject
>;

export type LiquidityGaugeDeployedEventFilter =
  TypedEventFilter<LiquidityGaugeDeployedEvent>;
