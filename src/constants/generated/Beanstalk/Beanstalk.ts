...
export interface BeanstalkInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getCurrentHumidity",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getFertilizers",
    values?: undefined
  ): string;
...
export type MetapoolOracleEvent = TypedEvent<
...
export type DepositApprovalEvent = TypedEvent<
...
export type ChopEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  ChopEventObject
>;
...
export type PickEvent = TypedEvent<
  [string, string, BigNumber],
  PickEventObject
>;
...
export interface Beanstalk extends BaseContract {
  ...
  functions: {
    ...
    ownerCandidate(
      overrides?: CallOverrides
    ): Promise<[string] & { ownerCandidate_: string }>;
  ...
  getFertilizers(
    overrides?: CallOverrides
  ): Promise<FertilizerFacet.SupplyStructOutput[]>;
