...
//  TODO: Do we need this typing? What does this do?
// type BigNumbers = TokenValue | BigNumber | ethers.BigNumber;
...
export class Silo {
  ...
  private _applyDeposit(
    ...
    const bdv = Silo.sdk.tokens.BEAN.fromHumanToTokenValue(rawCrate.bdv);
