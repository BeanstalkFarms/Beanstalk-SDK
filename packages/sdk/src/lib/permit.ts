...
//
export type EIP712TypedData<Message extends EIP712PermitMessage | DaiPermitMessage = any, Domain extends EIP712Domain = EIP712Domain> = {
  types: {
