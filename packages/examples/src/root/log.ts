...
export const logBalances = async (account: string, inputToken: Token, depositToken: ERC20Token, label: string) => {
  ...
  console.log(`(1) ${inputToken.symbol}:`, accountBalanceOfINPUT.total.toHuman());
  console.log(`(2) ${depositToken.symbol}:`, accountBalanceOfDEPOSIT.total.toHuman());
  console.log(`(3) ROOT:`, accountBalanceOfROOT.total.toHuman());
  console.log(`\nPIPELINE`);
  console.log(`(4) ETH :`, pipelineBalanceOfETH.toHuman());
  console.log(`(5) ${depositToken.symbol}:`, pipelineBalanceOfDEPOSIT.total.toHuman());
  console.log(`(6) ROOT:`, pipelineBalanceOfROOT.total.toHuman());
  console.log(`(7) ${depositToken.symbol} Deposits:`, pipelineSiloBalance.deposited.crates.length, ` Crates deposited in the Silo`);
  console.log(`\nDEPOT`);
